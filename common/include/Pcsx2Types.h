...
union u128
{
    ...
    wxString ToString128() const;
    wxString ToString64() const;
    wxString ToString8() const;

    wxString ToStringBigEndian() const;
    wxString ToString128BigEndian() const;
    wxString ToString64BigEndian() const;
    wxString ToString8BigEndian() const;
